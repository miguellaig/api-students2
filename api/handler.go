...
func (api *API) getStudents(c echo.Context) error {
	...
	if active != "" {
		...
		if err != nil { // Verificação do erro após a chamada
			log.Error().Err(err).Msgf("[api] error to get filtered students")
...
func (api *API) updateStudent(c echo.Context) error {
	...
	student := updateStutendInfo(receivedStudent, updatingStudent)
...
func updateStutendInfo(receivedStudent, student schemas.Student) schemas.Student {
